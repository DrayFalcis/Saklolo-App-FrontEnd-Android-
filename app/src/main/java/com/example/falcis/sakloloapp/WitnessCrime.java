...
public class WitnessCrime extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_witness_crime);

        Spinner spinner = findViewById(R.id.crime_list);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.crimes, android.R.layout.simple_spinner_item);
        ...
        data1 = (Spinner) findViewById(R.id.crime_list);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(WitnessCrime.this, "Sending Report", Toast.LENGTH_SHORT).show();

                Intent intent = getIntent();
                String nameDisplay = intent.getStringExtra("NAME4");
                ...
                userReport.put("Type", "WitnessCrime");

                mFirestore.collection("Crimes").add(userReport).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    @Override
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        findViewById(R.id.crime_list).setVisibility(View.GONE);
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(WitnessCrime.this, "Error: " + error, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
