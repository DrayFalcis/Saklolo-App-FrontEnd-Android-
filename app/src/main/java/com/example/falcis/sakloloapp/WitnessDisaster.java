...
public class WitnessDisaster extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_witness_disaster);

        Spinner spinner = findViewById(R.id.disaster_list);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.disaster, android.R.layout.simple_spinner_item);
        ...
        data1 = (Spinner) findViewById(R.id.disaster_list);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(WitnessDisaster.this, "Sending Report", Toast.LENGTH_SHORT).show();
                ...
                userReport.put("Disaster", myData1);
                ...
                userReport.put("Type", "WitnessDisaster");

                mFirestore.collection("Disaster").add(userReport).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    @Override
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        findViewById(R.id.disaster_list).setVisibility(View.GONE);
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(WitnessDisaster.this, "Error: " + error, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
